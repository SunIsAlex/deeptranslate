...
要求:
- senses 按常用度列出最多 3 个义项；每个 zh 与 translation 中对应义项一致，translation 等于所有 zh 用 " / " 连接；每项 phonetic 必须是该义项对应读音的 IPA 音标
...
word:
{ "type":"word", "translation":"释义,/分隔最多3个", "senses":[{"zh":"中文义项","phonetic":"该义项读音的音标带//","definition":"Concise English definition of this sense."}], "analysis":{ "pos":"词性", "inflections":[{"form":"变形","label":"类型"}], "morphology":[{"part":"成分","kind":"prefix|root|suffix|combining_form","meaning":"含义≤6字"}], "examples":["例句 — 翻译"] } }
...
- word 和 phrase 的 senses 按常用度列出最多 3 个义项；每个 zh 与 translation 中对应义项一致，translation 等于所有 zh 用 " / " 连接；word 的每项 phonetic 必须是该义项对应读音的 IPA 音标
